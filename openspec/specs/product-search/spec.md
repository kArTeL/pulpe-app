...
Free-text and category-filtered product search for the catalog app, backed by `GET /products/search`, with paginated results and per-category match counts to drive the filter UI.
